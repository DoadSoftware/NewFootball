...
public class I_League extends Scene{
...
//					penaltiesremove = new ArrayList<String>();
		...
		case "POPULATE-PENALTY": case "POPULATE-L3-SINGLE_SUBSTITUTE":
			switch(whatToProcess.toUpperCase()) {
			...
			case "POPULATE-POINTS_TABLE":
				...
				populatePointsTable(print_writer, valueToProcess.split(",")[1],league_table.getLeagueTeams(),footballService.getTeams(),session_selected_broadcaster,match);
				break;
		...
		case "ANIMATE-SCOREBUG-CARD":case "ANIMATE-SCOREBUG-SUBS":
		...
		case "ANIMATE-IN-DOUBLE_SUBS": case "ANIMATE-IN-OFFICIALS": case "ANIMATE-IN-HIGHLIGHT": case "ANIMATE-IN-PENALTY": case "ANIMATE-IN-SINGLE_SUBSTITUTE":
			...
			case "ANIMATE-CHANGE_ON":
				processAnimation(print_writer, "ChangeIn", "START", session_selected_broadcaster,2);
				break;
			...
			case "ANIMATE-OUT":
				...
				case "NAMESUPERDB": case "NAMESUPER": case "MATCHID": case "PLAYINGXI": case "BUG-DB": case "SCOREUPDATE": case "MATCHSTATUS": case "NAMESUPER_CARD":
				case "ASTON-ADS": case "SUBSTITUTE": case "MATCHPROMO": case "STAFF": case "MATCHSTATS": case "BUG_REPLAY": case "PROMO": case "DOUBLE_PROMO":
				case "POINTS_TABLE": case "FORMATION": case "FORMATION_WITHOUT": case "DOUBLE_SUBS": case "OFFICIALS": case "HIGHLIGHT": case "PENALTY":
				case "SINGLE_SUBSTITUTE":
...
//		scorebug.setLast_scorebug_stat(scorebug.getScorebug_stat().toUpperCase());
				...
				for(Player hs : match.getHomeSquad()) {
					if(playerId == hs.getPlayerId()) {
						...
						if(captainGoalKeeper.toUpperCase().equalsIgnoreCase("PLAYER")) {
							...
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + hs.getRole().toUpperCase() + " , " + match.getHomeTeam().getTeamName4().toUpperCase() + ";");
							TimeUnit.MILLISECONDS.sleep(l);
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTime " + " " + ";");
						}
					}
				...
				for(Player hsub : match.getHomeSubstitutes()) {
					if(playerId == hsub.getPlayerId()) {
						...
						if(captainGoalKeeper.toUpperCase().equalsIgnoreCase("PLAYER")) {
							...
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + hsub.getRole().toUpperCase() + " , " + match.getHomeTeam().getTeamName4().toUpperCase() + ";");
							TimeUnit.MILLISECONDS.sleep(l);
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTime " + " " + ";");
						}
					}
				...
				for(Player as : match.getAwaySquad()) {
					if(playerId == as.getPlayerId()) {
						...
						if(captainGoalKeeper.toUpperCase().equalsIgnoreCase("PLAYER")) {
							...
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + as.getRole().toUpperCase() + " , " + match.getHomeTeam().getTeamName4().toUpperCase() + ";");
							TimeUnit.MILLISECONDS.sleep(l);
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTime " + " " + ";");
						}
					}
				...
				for(Player asub : match.getAwaySubstitutes()) {
					if(playerId == asub.getPlayerId()) {
						...
						if(captainGoalKeeper.toUpperCase().equalsIgnoreCase("PLAYER")) {
							...
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + asub.getRole().toUpperCase() + " , " + match.getHomeTeam().getTeamName4().toUpperCase() + ";");
							TimeUnit.MILLISECONDS.sleep(l);
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTime " + " " + ";");
						}
					}
	...
	public void populateMatchId(PrintWriter print_writer,String viz_scene, Match match, String session_selected_broadcaster) throws InterruptedException, IOException
	{
		if (match == null) {
			...
			TimeUnit.MILLISECONDS.sleep(l);
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgHomeTeamLogo " + logo_path + match.getHomeTeam().getTeamName4().toUpperCase() + FootballUtil.PNG_EXTENSION + ";");
			TimeUnit.MILLISECONDS.sleep(l);
			...
			TimeUnit.MILLISECONDS.sleep(l);
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tInfo " + "LIVE FROM "+ match.getVenueName().toUpperCase() + ";");
			TimeUnit.MILLISECONDS.sleep(l);
	...
	public void populatePlayingXI(PrintWriter print_writer,String viz_scene, int TeamId,List<Formation> formation, List<Team> team ,Match match, String session_selected_broadcaster) throws InterruptedException, IOException 
	{
		if (match == null) {
			...
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHeader " + team.get(TeamId-1).getTeamName1().toUpperCase() + ";");
			if(team.get(TeamId-1).getTeamCoach() == null) {
				...
				print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tCoachName " + team.get(TeamId-1).getTeamCoach().toUpperCase() + ";");
			}
		...
		if (match == null) {
			...
			for(Team TM : team) {
				if(fix.get(match_number - 1).getHometeamid() == TM.getTeamId()) {
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgHomeTeamLogo " + logo_path + TM.getTeamName4().toUpperCase() + FootballUtil.PNG_EXTENSION + ";");
					TimeUnit.MILLISECONDS.sleep(l);
				...
				if(fix.get(match_number - 1).getAwayteamid() == TM.getTeamId()) {
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgAwayTeamLogo " + logo_path + TM.getTeamName4().toUpperCase() + FootballUtil.PNG_EXTENSION + ";");
					TimeUnit.MILLISECONDS.sleep(l);
	...
	{		
		...
		int row_no=0,l=4;
		//print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTeamFirstName " + "HERO" + ";");
		//TimeUnit.MILLISECONDS.sleep(l);
		//print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tTeamLastName " + "I-LEAGUE 2022-23" + ";");
		//TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHeader " + "POINTS TABLE" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		...
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadA " + "POS" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadB " + "TEAMS" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadC " + "P" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadD " + "W" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadE " + "D" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadF " + "L" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadG " + "GD" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatHeadH " + "PTS" + ";");
		TimeUnit.MILLISECONDS.sleep(l);
		...
		for(int i = 0; i <= point_table.size() - 1 ; i++) {
			...
			for(Team tm : team) {
				if(tm.getTeamName1().contains(point_table.get(i).getTeamName())) {
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsTeamLogo0" + row_no + " " + logo_path + 
							tm.getTeamName4() + FootballUtil.PNG_EXTENSION + ";");
					TimeUnit.MILLISECONDS.sleep(l);
					
					if(point_table.get(i).getQualifiedStatus().trim().equalsIgnoreCase("")) {
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsTeamName0" + row_no + " " + tm.getTeamName4().toUpperCase() + ";");
						TimeUnit.MILLISECONDS.sleep(l);
					}else {
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsTeamName0" + row_no + " " + "(Q) " + tm.getTeamName4().toUpperCase() + ";");
						TimeUnit.MILLISECONDS.sleep(l);
					}
				}
			}
			...
			TimeUnit.MILLISECONDS.sleep(l);
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatValue" + (row_no + 1) + "C" + " " + point_table.get(i).getDrawn() + ";");
			TimeUnit.MILLISECONDS.sleep(l);
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatValue" + (row_no + 1) + "D" + " " + point_table.get(i).getLost() + ";");
			TimeUnit.MILLISECONDS.sleep(l);
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatValue" + (row_no + 1) + "E" + " " + point_table.get(i).getGD() + ";");
			TimeUnit.MILLISECONDS.sleep(l);
			print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tPointsStatValue" + (row_no + 1) + "F" + " " + point_table.get(i).getPoints() + ";");
			TimeUnit.MILLISECONDS.sleep(l);
		...
		print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*In STOP;");
		print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*Out STOP;");
		print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*In SHOW 121.0;");
		print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*Out SHOW 0.0;");
		print_writer.println("LAYER1*EVEREST*GLOBAL SNAPSHOT_PATH C:/Temp/Preview.png;");
		print_writer.println("LAYER1*EVEREST*GLOBAL SNAPSHOT 1920 1080;");
		TimeUnit.SECONDS.sleep(1);
		...
		if (match == null) {
			...
			case "FORMATION_WITH_IMAGE":
				if(TeamId == match.getHomeTeamId()) {
					...
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHeader " + match.getHomeTeam().getTeamName1().toUpperCase() + ";");
					
					for(Formation form : formation) {
						if(form.getFormId() == match.getHomeTeamFormationId()) {
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tFormation " + form.getFormDescription() + ";");
							
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos1 " + form.getFormOrds1X() + "_" + form.getFormOrds1Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos2 " + form.getFormOrds2X() + "_" + form.getFormOrds2Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos3 " + form.getFormOrds3X() + "_" + form.getFormOrds3Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos4 " + form.getFormOrds4X() + "_" + form.getFormOrds4Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos5 " + form.getFormOrds5X() + "_" + form.getFormOrds5Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos6 " + form.getFormOrds6X() + "_" + form.getFormOrds6Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos7 " + form.getFormOrds7X() + "_" + form.getFormOrds7Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos8 " + form.getFormOrds8X() + "_" + form.getFormOrds8Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos9 " + form.getFormOrds9X() + "_" + form.getFormOrds9Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos10 " + form.getFormOrds10X() + "_" + form.getFormOrds10Y() + "_" + "0.0" + ";");
							print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerPos11 " + form.getFormOrds11X() + "_" + form.getFormOrds11Y() + "_" + "0.0" + ";");
							TimeUnit.MILLISECONDS.sleep(l);
						}
					}
					...
					for(Player hs : match.getHomeSquad()) {
						row_id = row_id + 1;
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerNumber"+ row_id + " " + "" + ";");
						TimeUnit.MILLISECONDS.sleep(l);
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerNumber"+ row_id + " " + hs.getJersey_number() + ";");
						TimeUnit.MILLISECONDS.sleep(l);
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerFirstName"+ row_id + " " + hs.getTicker_name().toUpperCase() + ";");
						TimeUnit.MILLISECONDS.sleep(l);
					...
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHeader " + match.getAwayTeam().getTeamName1().toUpperCase() + ";");
					...
					for(Player as : match.getAwaySquad()) {
						...
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerNumber"+ row_id + " " + "" + ";");
						TimeUnit.MILLISECONDS.sleep(l);
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerNumber"+ row_id + " " + as.getJersey_number() + ";");
						TimeUnit.MILLISECONDS.sleep(l);
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET tHomePlayerFirstName"+ row_id + " " + as.getTicker_name().toUpperCase() + ";");
						TimeUnit.MILLISECONDS.sleep(l);
						print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgHomePlayerImage"+ row_id + " " + photo_path + match.getAwayTeam().getTeamName4().toUpperCase() + "\\" + as.getPhoto() + ".png" + ";");
			...
			case "FORMATION_WITHOUT_IMAGE":
				if(TeamId == match.getHomeTeamId()) {
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgTeamLogo " + logo_path + match.getHomeTeam().getTeamName4().toUpperCase() + FootballUtil.PNG_EXTENSION + ";");
					...
					print_writer.println("LAYER2*EVEREST*TREEVIEW*Main*FUNCTION*TAG_CONTROL SET lgTeamLogo " + logo_path + match.getAwayTeam().getTeamName4().toUpperCase() + FootballUtil.PNG_EXTENSION + ";");
			...
			print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*In STOP;");
			print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*Out STOP;");
			print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*In SHOW 115.0;");
			print_writer.println("LAYER2*EVEREST*STAGE*DIRECTOR*Out SHOW 0.0;");
			print_writer.println("LAYER1*EVEREST*GLOBAL SNAPSHOT_PATH C:/Temp/Preview.png;");
			print_writer.println("LAYER1*EVEREST*GLOBAL SNAPSHOT 1920 1080;");
			TimeUnit.SECONDS.sleep(1);
