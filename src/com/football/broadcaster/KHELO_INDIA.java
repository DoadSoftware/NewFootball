...
//					penaltiesremove = new ArrayList<String>();
		...
		case "POPULATE-OFFICIALS": case "POPULATE-PENALTY": case "POPULATE-L3-SINGLE_SUBSTITUTE":
			...
			case "POPULATE-POINTS_TABLE":
				...
				populatePointsTable(print_writer, valueToProcess.split(",")[1],league_table1.getLeagueTeams(),league_table2.getLeagueTeams(),
...
//						TimeUnit.MILLISECONDS.sleep(l);
	...
	public void populatePointsTable(PrintWriter print_writer,String viz_sence_path,List<LeagueTeam> point_table1,List<LeagueTeam> point_table2, List<Team> team,String session_selected_broadcaster,Match match) throws InterruptedException, IOException 
	{		
